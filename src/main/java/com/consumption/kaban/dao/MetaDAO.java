...
public class MetaDAO {
    ...
    // Salva uma nova meta associada a um projeto
    public void salvar(Meta meta, int idProjeto) throws SQLException {
        ...
        stmt.setInt(4, meta.getProjetoId());
        stmt.executeUpdate();
    ...
    public List<Meta> buscarPorProjeto(int idProjeto) throws SQLException {
